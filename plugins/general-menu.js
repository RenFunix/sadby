...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    //conn.sendHydrated(m.chat, text.trim(), conn.getName(conn.user.jid), await genProfile(conn, m), 'https://chat.whatsapp.com/JMv6TBnYGCe7NngMhLdGmb', 'gc bot', null, null, [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], m)
   // conn.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/c38ba047ac5e9894f5940.mp4' }, gifPlayback: true, gifAttribution: ~~(Math.random() * 2), caption: text.trim(), footer: await conn.getName(conn.user.jid) , templateButtons: [{ quickReplyButton: { displayText: 'Speedtest', id: `${_p}ping` }}, { quickReplyButton: { displayText: 'Owner', id: `${_p}owner` }} ] })
...
mediaType: 'VIDEO',
mediaUrl: 'https://telegra.ph/file/be3ed2cff52c3bb9b0d52.jpg',
